...
const OUTPUT_DIR = path.join(process.cwd(), 'debug', 'qwen', 'processed-21-30-v2');
...
async function main() {
  console.log('🚀 PROCESSAMENTO DOS PRODUTOS 21-30 - V2 MELHORADO\n');
  ...
  console.log('   2️⃣  Smart blur INTENSO (blur=30)\n');
  ...
  const allImages = fs.readdirSync(SOURCE_DIR)
    ...
    .sort()
    .slice(20, 30); // Products 21-30

  console.log(`📸 Total de imagens para processar: ${allImages.length}\n`);
  console.log(`🔢 Processando produtos 21-30\n`);
  ...
  console.log('\n' + '='.repeat(80));
  console.log('📊 RESUMO DO PROCESSAMENTO (PRODUTOS 21-30 V2)\n');
  ...
  console.log('\n📊 PROGRESSO GERAL:');
  console.log(`   Total processado até agora: 30/476 produtos (6%)`);
  console.log(`   Faltam: 446 produtos`);
