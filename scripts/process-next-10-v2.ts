...
const OUTPUT_DIR = path.join(process.cwd(), 'debug', 'qwen', 'processed-11-20-v2');
...
async function main() {
  console.log('🚀 PROCESSAMENTO DOS PRÓXIMOS 10 PRODUTOS (11-20) - V2 MELHORADO\n');
  ...
  console.log(`🔢 Processando produtos 11-20\n`);
  ...
  console.log('\n' + '='.repeat(80));
  console.log('📊 RESUMO DO PROCESSAMENTO (PRODUTOS 11-20 V2)\n');
